    ...
    Private Sub calcularHoras100()
        Try
            If txtHoras100.TextLength > 0 Then
                txtP100.Text = ((CDbl(txtValo.Text)) * CDbl(txtHoras100.Text))
            End If
        Catch ex As Exception
    ...
    Private Sub calcularHoras50()
        Try
            If txtHoras50.TextLength > 0 Then
                txtP50.Text = ((CDbl(txtValo.Text) / 2) * CDbl(txtHoras50.Text))
    ...
    Private Sub calcularIngresos()
        ...
        Try
            If txtSueldoFijo.TextLength > 0 And txtP100.TextLength > 0 And txtP50.TextLength > 0 Then
                txtTotalIngresos.Text = (CDbl(txtSueldoFijo.Text) + CDbl(txtP100.Text) + CDbl(txtP50.Text))
            End If
        ...
        Try
            If txtTotalIngresos.TextLength > 0 Then
                If rdb0.Checked Then
                    txtTotalDescuento.Text = ((CDbl(txtTotalIngresos.Text) * 0))
                End If
                If rdb5.Checked Then
                    txtTotalDescuento.Text = ((CDbl(txtTotalIngresos.Text) * 0.05))
                End If
                If rdb10.Checked Then
                    txtTotalDescuento.Text = ((CDbl(txtTotalIngresos.Text) * 0.1))
                End If
                If rdb15.Checked Then
                    txtTotalDescuento.Text = ((CDbl(txtTotalIngresos.Text) * 0.15))
                End If
    ...
    Private Sub calcularEgresos()
        ...
        Try
            If txtTotalDescuento.TextLength > 0 And txtAnticipo.TextLength > 0 Then
                txtTotalEgresos.Text = (CDbl(txtTotalDescuento.Text) + CDbl(txtAnticipo.Text))
            End If
        Catch ex As Exception
            ventana.mensaje("Ingrese correctamente la Cantidad")
        End Try
    ...
    Private Sub calcularTotaPagar()
        ...
        Try
            If txtTotalEgresos.TextLength > 0 And txtTotalIngresos.TextLength > 0 Then
                txtTotalPagar.Text = (CDbl(txtTotalIngresos.Text) - CDbl(txtTotalEgresos.Text))
            End If
        Catch ex As Exception
            ventana.mensaje("Ingrese correctamente la Cantidad")
        End Try
